...
import '../features/mondex/domain/repositories/monster_repository.dart'
    as _i133;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i133.MonsterRepository>(
      () => _i160.LocalRepositoryImpl(gh<_i738.LocalDataSource>()),
    );
    gh.factory<_i584.GetAllMonsterUseCase>(
      () => _i584.GetAllMonsterUseCase(gh<_i133.MonsterRepository>()),
    );
    gh.factory<_i517.InsertAddDummyMonsterUseCase>(
      () => _i517.InsertAddDummyMonsterUseCase(gh<_i133.MonsterRepository>()),
    );
    gh.factory<_i301.InsertDummyMonsterUseCase>(
      () => _i301.InsertDummyMonsterUseCase(gh<_i133.MonsterRepository>()),
    );
    gh.factory<_i598.InsertMonsterUseCase>(
      () => _i598.InsertMonsterUseCase(gh<_i133.MonsterRepository>()),
    );
    return this;
  }
}
